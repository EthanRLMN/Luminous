...
void EditorStyle::SetupImGuiStyle()
{
    ...
    l_style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.400f, 0.400f, 0.400f, 1.0f);
    ...
    l_style.Colors[ImGuiCol_PopupBg] = ImVec4(0.150f, 0.200, 0.280f, 1.0f);
    l_style.Colors[ImGuiCol_Border] = ImVec4(0.160f, 0.170f, 0.200f, 1.0f);
    l_style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.0784313753247261f, 0.08627451211214066f, 0.1019607856869698f, 1.0f);
    l_style.Colors[ImGuiCol_FrameBg] = ImVec4(0.115f, 0.125f, 0.150f, 1.0f);
    ...
    l_style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.135f, 0.165f, 0.200f, 1.0f);
    l_style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.130f, 0.170f, 0.250f, 1.0f);
    l_style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.230f, 0.400, 0.700, 1.0f);
    l_style.Colors[ImGuiCol_CheckMark] = ImVec4(0.030, 1.0f, 0.850f, 1.0f);
    l_style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.135f, 0.165f, 0.200f, 1.0f);
    l_style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.230f, 0.400, 0.700, 1.0f);
    l_style.Colors[ImGuiCol_Button] = ImVec4(0.135f, 0.165f, 0.200f, 1.0f);
    l_style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.130f, 0.170f, 0.250f, 1.0f);
    l_style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.230f, 0.400, 0.700, 1.0f);
    l_style.Colors[ImGuiCol_Header] = ImVec4(0.150f, 0.165f, 0.200f, 1.0f);
    l_style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.130f, 0.170f, 0.240f, 1.0f);
    l_style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.170f, 0.275f, 0.500f, 1.0f);
    l_style.Colors[ImGuiCol_Separator] = ImVec4(0.25f, 0.25f, 0.25f, 1.0f);
    ...
    l_style.Colors[ImGuiCol_Tab] = ImVec4(0.150f, 0.170f, 0.200f, 1.0f);
    l_style.Colors[ImGuiCol_TabHovered] = ImVec4(0.150f, 0.220f, 0.350f, 1.0f);
    l_style.Colors[ImGuiCol_TabActive] = ImVec4(0.170f, 0.275f, 0.500f, 1.0f);
    l_style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.220f, 0.220f, 0.220f, 1.0f);
