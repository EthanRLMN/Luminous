...
void Scene::RegisterScene(EntityManager& a_entityManager)
{
    ...
    a_entityManager.GetEntities()[1].get()->GetComponent<TransformComponent>().get()->SetLocalRotationVec(Maths::Vector3(45.f, 0.f, 72.f));
    ...
    a_entityManager.GetEntities()[2].get()->GetComponent<TransformComponent>().get()->SetLocalRotationVec(Maths::Vector3(-18.75f, -55, 42.f));
    ...
    a_entityManager.GetEntities()[2].get()->GetComponent<TransformComponent>().get()->SetLocalPosition(Maths::Vector3(5.25f, -10.0f, 0.f));
