...
private:
	...
	void SetupDescriptorSetLayout(const std::vector<VkDescriptorSetLayout>& a_descriptorSetLayouts, VkPipelineLayoutCreateInfo& a_pipelineLayoutInfo, VkDevice a_device);
