...
public:
    ...
    [[nodiscard]] inline Maths::Matrix4 UpdateViewMatrix(const Maths::Vector3& a_position, const Maths::Vector3& a_direction, const Maths::Vector3& a_up) { return Maths::Matrix4::LookAt(a_position, a_direction, a_up).Transpose(); }
};
