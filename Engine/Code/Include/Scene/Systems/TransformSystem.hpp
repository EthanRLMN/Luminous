...
public:
    ...
    TransformSystem(const Maths::Matrix4& a_translation, const Maths::Matrix4& a_rotation, const Maths::Matrix4& a_scaling) :
        Translation(a_translation), Rotation(a_rotation), Scaling(a_scaling) {};
};
